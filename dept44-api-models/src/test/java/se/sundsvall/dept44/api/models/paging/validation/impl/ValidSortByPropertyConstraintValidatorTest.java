...
import se.sundsvall.dept44.api.models.paging.AbstractParameterPagingBase;
import se.sundsvall.dept44.api.models.paging.validation.ValidSortByProperty;
...
class ValidSortByPropertyConstraintValidatorTest {
	...
	void isNotValid() {
		...
		assertThat(validator.validate(parameters))
			...
			.isEqualTo("One or more of the sortBy members [notASortableField] are not valid. Valid properties to sort by are [myField, id, mySecondField].");
	}
