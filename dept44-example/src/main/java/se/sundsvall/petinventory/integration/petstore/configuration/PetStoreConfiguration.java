...
public class PetStoreConfiguration {
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final PetStoreProperties petstoreProperties,
		...
		return FeignMultiCustomizer.create()
			...
			.withRetryableOAuth2InterceptorForClientRegistration(clientRegistrationRepository.findByRegistrationId(
				CLIENT_ID))
