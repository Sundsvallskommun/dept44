 ...
 *
 * <p>
 * This class is used to set the health of a scheduled method. It provides methods to set the health indicator to healthy or unhealthy.
 *
 * <p>
 * Use this if you need to set the health of a scheduled method from within the method itself instead of relying on the aspect to catch exceptions.
 */
@Component
public class Dept44HealthUtility {
	...
	/**
	 * <p>Constructor for Dept44HealthUtility.
	 *
	 ...
	 *
	 * @param methodName the name of the scheduled method e.g. the name attribute of the {@link se.sundsvall.dept44.scheduling.Dept44Scheduled} annotation
	 */
