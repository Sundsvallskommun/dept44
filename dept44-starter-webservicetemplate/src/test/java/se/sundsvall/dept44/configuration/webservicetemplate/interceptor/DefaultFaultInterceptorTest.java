...
class DefaultFaultInterceptorTest {
	...
	void testHandleResponseWhenFaultPresent() {
		...
		ThrowableProblem problem =
				assertThrows(ThrowableProblem.class, () -> interceptor.handleResponse(messageContextMock));
	...
	void testHandleFaultWhenFaultPresent() {
		...
		// Call and assert
		ThrowableProblem problem =
				assertThrows(ThrowableProblem.class, () -> interceptor.handleFault(messageContextMock));
