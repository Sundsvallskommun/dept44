...
class ThrowableProblemTest {
	...
	void constructorWithAllFields() {
		...
		final var problem = new ThrowableProblem(type, "Title", BAD_REQUEST, "Detail", instance);
	...
	void constructorWithCause() {
		final var cause = new ThrowableProblem(null, "Cause", INTERNAL_SERVER_ERROR, "Cause detail", null);
		final var problem = new ThrowableProblem(null, "Title", BAD_GATEWAY, "Detail", null, cause);
	...
	void constructorWithNullType() {
		final var problem = new ThrowableProblem(null, "Title", BAD_REQUEST, "Detail", null);
	...
	void constructorWithNullStatus() {
		final var problem = new ThrowableProblem(null, "Title", (HttpStatus) null, "Detail", null);
	...
	void getMessageWithDetailOnly() {
		final var problem = new ThrowableProblem(null, null, BAD_REQUEST, "Detail", null);
	...
	void getMessageWithTitleOnly() {
		final var problem = new ThrowableProblem(null, "Title", BAD_REQUEST, null, null);
	...
	void getMessageWithStatusOnly() {
		final var problem = new ThrowableProblem(null, null, BAD_REQUEST, null, null);
	...
	void getMessageWithNothing() {
		final var problem = new ThrowableProblem(null, null, (HttpStatus) null, null, null);
	...
	void getCauseAsProblemWithNonProblemCause() {
		final var problem = Problem.valueOf(BAD_REQUEST, "Test");
